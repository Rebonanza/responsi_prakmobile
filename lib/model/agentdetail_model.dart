class AgentsDetailModel {
  ...
  AgentsDetailModel.fromJson(Map<String, dynamic> json)
  ...
  Data.fromJson(Map<String, dynamic> json)
      : uuid = json['uuid'] as String?,
        ...
        abilities = (json['abilities'] as List?)
            ...
            .toList(),
        voiceLine = (json['voiceLine'] as Map<String, dynamic>?) != null
  ...
  VoiceLine.fromJson(Map<String, dynamic> json)
      : minDuration = json['minDuration'] as double?,
        ...
        mediaList = (json['mediaList'] as List?)
            ?.map((dynamic e) => MediaList.fromJson(e as Map<String, dynamic>))
            .toList();
...
class MediaList {
  ...
  Map<String, dynamic> toJson() => {'id': id, 'wwise': wwise, 'wave': wave};
}
